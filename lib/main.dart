...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _onItemTapped(int index) {
    setState(() {
      ...
      if (selectedIndex == 3) {
        openUrl(context, url: "https://sophiahighschool.org/", color: Constants.primaryColor);
      }
    });
  }
    ...
    return Scaffold(
      ...
      bottomNavigationBar: CurvedNavigationBar(
        items: const [
          ...
          Icon(Icons.notifications_active_outlined, size: 30, color: Constants.primaryColorBlue),
          Icon(
            Icons.computer,
            size: 30,
            color: Constants.primaryColorBlue,
